...
public class TestElfShould {
    ...
    void compare_return_positive_value_for_elf_with_more_total_calories() {
        Elf elfA = new Elf();
        Elf elfB = new Elf();
        elfA.addCalories(1000);
        assertThat(elfA.compareTo(elfB), greaterThan(0));
    }
    ...
    void compare_zero_for_equal_elf() {
        Elf elfA = new Elf();
        Elf elfB = new Elf();
        assertThat(elfA.compareTo(elfB), equalTo(0));
    }
    ...
    void compare_return_negative_value_for_elf_with_less_total_calories() {
        Elf elfA = new Elf();
        Elf elfB = new Elf();
        elfB.addCalories(1000);
        assertThat(elfA.compareTo(elfB), lessThan(0));
    }
}
